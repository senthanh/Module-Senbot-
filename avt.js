...
module.exports.config = {
	...
	hasPermssion: 0, 
	credits: "SENPROJECT", 
	description: "blah blah blha",//TDUNG
	group: "image",
	usages: "",
	cooldowns: 5
};
...
module.exports.handleReply = async ({ api, event, handleReply }) => {
    ...
    case 4:
      content.color = input;
			...
			api.unsendMessage(handleReply.messageID);
			let c = content;
			let res = await axios.get(encodeURI(`https://dino.araxy.repl.co/taoanhdep?chu_ky=${c.ky}&chu_nen=${c.nen}&id=${c.nhanvat}&color=${c.color}`), { responseType: "arraybuffer" })
